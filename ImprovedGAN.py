...
#                    self.writer.add_histogram('fc3_bias', self.G.fc3.bias, gn)
                    ...
                    self.writer.add_histogram('D_final_weight', self.D.final.weight, gn)
                    self.writer.add_histogram('D_final_bias', self.D.final.bias, gn)
                    self.writer.add_histogram('D_first_weight', self.D.layers[0].weight, gn)
                    self.writer.add_histogram('D_first_bias', self.D.layers[0].bias, gn)
